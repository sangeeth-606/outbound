      ...
      <div className="min-h-screen bg-white text-black">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Advanced support specialist for complex issues</p>
          </div>
              ...
              <div className="bg-gray-100 rounded-lg shadow-md p-6 border border-gray-200">
                ...
                <div className="space-y-4">
                  <div className="bg-blue-100 border border-blue-400 rounded-lg p-4">
                    <h3 className="font-semibold text-blue-700 mb-2">Specialist Features</h3>
      ...
      <div className="min-h-screen bg-white text-black">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Advanced support specialist - handling complex issues</p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-100 rounded-lg shadow-md p-6 border border-gray-200">
                ...
                {callerContext ? (
                  <div className="space-y-4">
                    <div className="bg-indigo-100 border border-indigo-400 rounded-lg p-4">
                    ...
                    <div className="bg-green-100 border border-green-400 rounded-lg p-4">
                      <h3 className="font-semibold text-green-700 mb-2">Specialist Actions</h3>
                  ...
                  <div className="text-center py-8">
                    ...
                    <h3 className="text-lg font-semibold text-gray-500 mb-2">Waiting for Customer</h3>
