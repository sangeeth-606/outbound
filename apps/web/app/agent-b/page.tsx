        ...
        {isConnecting ? (
          ...
          <div className="h-full flex items-center justify-center">
            <div className="card p-8 text-center max-w-sm">
              <div className="w-12 h-12 rounded-full bg-accent-cyan/15 flex items-center justify-center mx-auto mb-4">
                <Phone className="w-6 h-6 text-accent-cyan" />
              </div>
              <h3 className="text-sm font-bold text-text-main mb-2">Ready for Transfers</h3>
              <p className="text-xs text-text-muted mb-6">
                Click below to connect and handle specialist transfers.
              </p>
